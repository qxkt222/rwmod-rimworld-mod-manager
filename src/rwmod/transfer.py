...
def export_bundle(cfg: Config, output_path: Path, include_backups: bool = True) -> dict:
    ...
    with zipfile.ZipFile(output_path, "w", zipfile.ZIP_DEFLATED) as zf:
        ...
        zf.writestr(_CONFIG, _export_config(cfg))
...
def _export_config(cfg: Config) -> str:
    """Serialize config, omitting machine-specific paths."""
    lines = []
